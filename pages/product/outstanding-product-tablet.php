    ...
    <!-- thẻ main-product -->
         <div class="top-content-s-p">
            <div class="ct-name-img">
                <div class="text p-name"><span>iPad Gen 10 10.9 inch 2022 Wifi 64GB</span></div>
                <div class="phone-sale-image"><img src="../../imgaes/tablet_noiBat/ipad-10-9-inch-2022.webp" alt="" width="100%"></div>
            </div>
