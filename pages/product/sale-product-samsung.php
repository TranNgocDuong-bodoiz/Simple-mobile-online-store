    ...
    <!-- thẻ main-product -->
         <div class="top-content-s-p">
            <div class="ct-name-img">
                <div class="text p-name"><span>Samsung Galaxy S24 Plus</span></div>
                <div class="phone-sale-image"><img src="../../imgaes/product/samsung-galaxy-s24-plus_1.webp" alt="" width="100%"></div>
            </div>
