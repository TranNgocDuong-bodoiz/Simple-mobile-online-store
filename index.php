    ...
    <div class="main">
        ...
        <div class="main_sale_product">
            ...
            <div class="sale_product">
                ...
                <a href="pages/product/sale-product-samsung.php">
                    <div class="sale_product_img">
                    <img src="imgaes/product/samsung-galaxy-s24-plus_1.webp" alt="samsung galaxy s24plus" width="100%">
                    </div>
                </a>
                <a href="pages/product/sale-product-samsung.php" style="text-decoration: none;">
                ...
                <div class="sale_product_buy_b">
                    <a href="pages/product/sale-product-samsung.php"><input type="button" value="mua ngay"></a>
                </div>
            </div>
        ...
        <div class="outstandingPhone"> <!-- mo the outstanding phone-->
             ...
             <div class="outstandingPhone__phone_container">
                <div class="outstandingPhone__phone_container__phone"> <!-- mo the phone -->
                     ...
                     <a href="pages/product/outstanding-product-iphone.php"><div class="outstandingPhone__phone_container__phone__phone_image"><img src="imgaes/dt_noiBat/iphone-16-pro-max.webp" alt="" width="100%"></div></a>
                     <a href="pages/product/outstanding-product-iphone.php"><div class="outstandingPhone__phone_container__phone__phone_name"><span>iPhone 16 Pro Max</span></div></a>
        ...
        <div class="outstandingTablet"> <!-- mo the outstanding tablet-->
             ...
             <div class="outstandingTablet__tablet_container">
                <div class="outstandingTablet__tablet_container__tablet"> <!-- mo the tablet -->
                     ...
                     <a style="text-decoration: none;" href="pages/product/outstanding-product-tablet.php"><div class="outstandingTablet__tablet_container__tablet__tablet_image"><img src="imgaes/tablet_noiBat/ipad-10-9-inch-2022.webp" alt="" width="100%"></div></a>
                     <a style="text-decoration: none;" href="pages/product/outstanding-product-tablet.php"><div class="outstandingTablet__tablet_container__tablet__tablet_name"><span>iPad Gen 10 10.9 inch 2022 Wifi 64GB</span></div></a>
